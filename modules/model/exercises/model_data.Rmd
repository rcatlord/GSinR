...
For example the package *car* has a function `residdual plots` which produces residual plots from your model. So from our fit_2 above, we can see our residual plots by passing the regression to the function: 
