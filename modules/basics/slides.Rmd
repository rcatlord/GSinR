...
- Companies like Google, Facebook and the Financial Times use it. The [BBC](https://bbc.github.io/rcookbook/#how_to_create_bbc_style_graphics) have also recently made a big push to use it for their visualisations.
...
### Charts
```{r out.width='700px', fig.height=3, fig.align='center', message = F, warning - F}
library(ggplot2) 
